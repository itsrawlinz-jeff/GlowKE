...
function AllProductPage({ response , sellerInfo  }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        if (categoryExistInRoute) {
            axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(`${"https://adminglow.labandallied.co.ke/public"}api/product?category=${router.query.category}`).then((res)=>{
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        if (response.data) {
            ...
            if (check) {
                ...
                axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(`${"https://adminglow.labandallied.co.ke/public"}api/search-product?${brandString && brandString}${categoryString && categoryString}${variantString && variantString}min_price=${volume[0]}&max_price=${volume[1]}${sellerInfo ? `&shop_name=${sellerInfo.seller.slug}` : ""}`).then((res)=>{
                                        ...
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            ...
                                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                ...
                                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_3___default()), {
                                                    ...
                                                    src: `${"https://adminglow.labandallied.co.ke/public" + sellerInfo.seller.logo}`,
                                                    alt: "logo",
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        response.data && response.data.shopPageSidebarBanner && parseInt(response.data.shopPageSidebarBanner.status) === 1 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            style: {
                                                backgroundImage: `url(${"https://adminglow.labandallied.co.ke/public" + response.data.shopPageSidebarBanner.image})`,
                                                backgroundSize: `cover`,
...
function OneColumnAdsTwo({ data  }) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            style: {
                backgroundImage: `url(${"https://adminglow.labandallied.co.ke/public" + data.image})`,
                backgroundSize: `cover`,
                backgroundRepeat: `no-repeat`
            },
