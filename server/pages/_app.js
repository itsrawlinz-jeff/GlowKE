...
/* harmony import */ var _Helpers_Consent__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(7208);
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(1853);
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _utils_apiRequest__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9808);
...
/* harmony import */ var _Auth_Login_LoginWidget__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(3865);
/* harmony import */ var _Auth_Signup_SignupWidget__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(3113);
/* harmony import */ var _Auth_Signup_VerifyWidget__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(685);
/* harmony import */ var _utils_hexToRgb__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(7746);
/* harmony import */ var _tawk_to_tawk_messenger_react__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(1725);
/* harmony import */ var _tawk_to_tawk_messenger_react__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_tawk_to_tawk_messenger_react__WEBPACK_IMPORTED_MODULE_17__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([axios__WEBPACK_IMPORTED_MODULE_1__, _utils_apiRequest__WEBPACK_IMPORTED_MODULE_12__, react_toastify__WEBPACK_IMPORTED_MODULE_13__, _Auth_Login_LoginWidget__WEBPACK_IMPORTED_MODULE_14__, _Auth_Signup_SignupWidget__WEBPACK_IMPORTED_MODULE_15__, _Auth_Signup_VerifyWidget__WEBPACK_IMPORTED_MODULE_16__]);
([axios__WEBPACK_IMPORTED_MODULE_1__, _utils_apiRequest__WEBPACK_IMPORTED_MODULE_12__, react_toastify__WEBPACK_IMPORTED_MODULE_13__, _Auth_Login_LoginWidget__WEBPACK_IMPORTED_MODULE_14__, _Auth_Signup_SignupWidget__WEBPACK_IMPORTED_MODULE_15__, _Auth_Signup_VerifyWidget__WEBPACK_IMPORTED_MODULE_16__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function DefaultLayout({ children  }) {
    ...
    const getLoginContexts = (0,react__WEBPACK_IMPORTED_MODULE_2__.useContext)(_Contexts_LoginContexts__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z);
    ...
    const apiFetch = ()=>{
        axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(`${"https://adminglow.labandallied.co.ke/public"}api/website-setup`).then((res)=>{
            // handle success
            ...
            if ((0,_utils_auth__WEBPACK_IMPORTED_MODULE_20__/* ["default"] */ .Z)()) {
                ...
                if (holdData && holdData.type === "add-to-cart") {
                    if (holdData.variants) {
                        ...
                        _utils_apiRequest__WEBPACK_IMPORTED_MODULE_12__/* ["default"].addToCard */ .Z.addToCard(uri).then((res)=>{
                            react_toastify__WEBPACK_IMPORTED_MODULE_13__.toast.success(langCntnt && langCntnt.Item_added);
                            localStorage.removeItem("data-hold");
                            router.push("/cart");
                        }).catch((err)=>{
                            console.log(err);
                            react_toastify__WEBPACK_IMPORTED_MODULE_13__.toast.error(err.response && err.response.data.message && err.response.data.message);
                        });
                        dispatch((0,_store_Cart__WEBPACK_IMPORTED_MODULE_4__/* .fetchCart */ .x7)());
                    } else {
                        ...
                        _utils_apiRequest__WEBPACK_IMPORTED_MODULE_12__/* ["default"].addToCard */ .Z.addToCard(uri1).then((res)=>{
                            react_toastify__WEBPACK_IMPORTED_MODULE_13__.toast.success(langCntnt && langCntnt.Item_added);
                            localStorage.removeItem("data-hold");
                            router.push("/cart");
                        }).catch((err)=>{
        ...
        `
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                children: load && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_Consent__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z, {}),
                        ...
                        twkData && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_tawk_to_tawk_messenger_react__WEBPACK_IMPORTED_MODULE_17___default()), {
                        ...
                        getLoginContexts.loginPopup && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                    ...
                                    children: popupView === "login" ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Auth_Login_LoginWidget__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z, {
                                        redirect: false,
                                        loginActionPopup: loginActionPopup,
                                        notVerifyHandler: notVerifyHandler
                                    }) : popupView === "signup" ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Auth_Signup_SignupWidget__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z, {
                                        redirect: false,
                                        signupActionPopup: signupActionPopup,
                                        changeContent: singupActionHandle
                                    }) : popupView === "verify" ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Auth_Signup_VerifyWidget__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Z, {
                                        redirect: false,
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        ...
                        children: maintain && /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                            ...
                            src: `${"https://adminglow.labandallied.co.ke/public" + maintain.image}`,
                            alt: "logo"
                        })
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
