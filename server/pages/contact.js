...
async function getServerSideProps() {
    ...
    const res = await fetch(`${"https://adminglow.labandallied.co.ke/public"}api/contact-us`);
    ...
    const sendHandler = ()=>{
        ...
        _utils_apiRequest__WEBPACK_IMPORTED_MODULE_4__/* ["default"].contact */ .Z.contact({
            ...
            if (err.response.status === 403) {
                react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast.error(err.response.data.message);
            }
        });
    };
