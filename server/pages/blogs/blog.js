...
const getServerSideProps = async (context)=>{
    if (context && context.query.slug) {
        const res = await fetch(`${"https://adminglow.labandallied.co.ke/public"}api/blog/${context.query.slug}`);
    ...
    const subscribehandler = ()=>{
        _utils_apiRequest__WEBPACK_IMPORTED_MODULE_5__/* ["default"].subscribeRequest */ .Z.subscribeRequest({
            ...
            if (err.response.status === 403) {
                react_toastify__WEBPACK_IMPORTED_MODULE_4__.toast.error(err.response.data.message);
            }
        });
    };
                                    ...
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            ...
                                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_1___default()), {
                                                layout: "fill",
                                                src: `${"https://adminglow.labandallied.co.ke/public" + details.blog.image}`,
                                                alt: "blog",
                                                className: "w-full h-full object-cover"
                                            })
                                        }),
                                                    ...
                                                    children: details.popularPosts.length > 0 && details.popularPosts.map((post)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("li", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                                    ...
                                                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_1___default()), {
                                                                        layout: "fill",
                                                                        src: `${"https://adminglow.labandallied.co.ke/public" + post.blog.image}`,
                                                                        alt: "blog",
                                                                        className: "w-full h-full object-cover"
                                                                    })
                                                                }),
