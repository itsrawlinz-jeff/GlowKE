...
const getServerSideProps = async (context)=>{
    const res = await fetch(`${"https://adminglow.labandallied.co.ke/public"}api/product/${context.query.slug}`);
                        ...
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                ...
                                children: seller.user && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_1___default()), {
                                    layout: "fill",
                                    src: `${seller.user.image ? "https://adminglow.labandallied.co.ke/public" + seller.user.image : "/assets/images/Group.png"}`,
                                    alt: "saller",
                                    className: "w-full h-full object-cover"
                                })
                            }),
        ...
        if (!commnets) {
            const reviews = details && details.productReviews.length > 0 && details.productReviews.map((review)=>{
                return {
                    ...
                    replys: null,
                    image: review.user.image ? "https://adminglow.labandallied.co.ke/public" + review.user.image : null
                };
            });
            setComments(reviews);
        }
